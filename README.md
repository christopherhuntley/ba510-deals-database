...
9. __Run the notebook to confirm that everything works.__ You can run the cells one at a time or all at once. You should get a listing of companies with the phrase 'Inc.' in their name.
